...
void DX12App::init(HWND hwnd, int width, int height)
{
	...
	// Comprobar si DXGI permite presentar sin sincronización vertical real
	...
	rootSigDesc.Init(
		1,                // 1 par�metro ra�z (el cbuffer)
		&rootParam,       // puntero al par�metro
...
void DX12App::render()
{
	...
	m_commandList->DrawInstanced(3, 1, 0, 0); // tri�ngulo
